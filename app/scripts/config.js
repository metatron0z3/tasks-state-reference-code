...
.constant('WEB_SERVER_URL', 'http://localhost:9000')
.constant('API_SERVER_URL', 'http://localhost:3001')
.constant('UPLOAD_SERVER_URL', 'http://localhost:3000')
.constant('NOTIFICATION_SERVER_URL', 'http://localhost:3004')
